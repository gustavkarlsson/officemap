...
public class AreaDaoTest extends AbstractDaoTest {
	...
	private static final Area validArea1 = Area
			...
			.with(null,
					null,
					new AreaReference(1l, Collections.<Area> emptyList()),
					false,
					"Floor 1",
					FileEntry.builder().withSha1Hex("cf23df2207d99a74fbe169e3eba045e633b65d94")
							.withMimeType("application/png").build(), null).build();
	private static final Area validArea2 = Area
			...
			.with(1l,
					...
					true,
					"Floor 2",
					FileEntry.builder().withSha1Hex("cf23df2207d99a74abe169e3eba035e633b65d94")
							.withMimeType("application/jpeg").build(), null).build();
	private static final Area validArea3 = Area
			...
			.with(null,
					...
					false,
					"Floor 3",
					FileEntry.builder().withSha1Hex("cf23df2207d93a74fbe169e3eba035e633b65d94")
							.withMimeType("application/pdf").build(), null).build();
